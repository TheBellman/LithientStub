...
import com.lithient.api.CollectorService;
import com.lithient.api.StatusService;
...
public final class JettyServer {
    ...
    public void start() throws Exception {
        ...
        ResourceConfig config = new ResourceConfig(CollectorService.class, StatusService.class).register(JacksonFeature.class);
